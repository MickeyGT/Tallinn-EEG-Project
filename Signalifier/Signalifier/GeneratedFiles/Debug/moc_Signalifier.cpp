...
QT_MOC_LITERAL(3, 18, 25), // "updateBitalinoDevice1Plot"
QT_MOC_LITERAL(4, 44, 5), // "value"
QT_MOC_LITERAL(5, 50, 18), // "changeUDPSendingIp"
QT_MOC_LITERAL(6, 69, 11) // "startDevice"

    },
    "Signalifier\0test\0\0updateBitalinoDevice1Plot\0"
    "value\0changeUDPSendingIp\0startDevice"
};
...
void Signalifier::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->updateBitalinoDevice1Plot((*reinterpret_cast< const double(*)>(_a[1]))); break;
        case 2: _t->changeUDPSendingIp(); break;
        case 3: _t->startDevice(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Signalifier::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Signalifier::test)) {
                *result = 0;
                return;
            }
        }
