...
QT_MOC_LITERAL(1, 22, 23), // "processTimeDomainValues"
QT_MOC_LITERAL(2, 46, 0), // ""
QT_MOC_LITERAL(3, 47, 12), // "QVector<int>"
QT_MOC_LITERAL(4, 60, 16), // "processFftValues"
QT_MOC_LITERAL(5, 77, 20) // "QPair<double,double>"

    },
    "ShooterGameConnection\0processTimeDomainValues\0"
    "\0QVector<int>\0processFftValues\0"
    "QPair<double,double>"
};
...
void ShooterGameConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->processTimeDomainValues((*reinterpret_cast< const QVector<int>(*)>(_a[1]))); break;
        case 1: _t->processFftValues((*reinterpret_cast< const QPair<double,double>(*)>(_a[1]))); break;
        default: ;
        }
