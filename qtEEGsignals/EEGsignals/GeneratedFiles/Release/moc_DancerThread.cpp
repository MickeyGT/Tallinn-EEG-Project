/****************************************************************************
** Meta object code from reading C++ file 'DancerThread.h'
**
...
#error "The header file 'DancerThread.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 13, 15), // "processDatagram"
QT_MOC_LITERAL(2, 29, 0) // ""

    },
    "DancerThread\0processDatagram\0"
};
...
QT_INIT_METAOBJECT const QMetaObject DancerThread::staticMetaObject = {
    { &DataReceivingThread::staticMetaObject, qt_meta_stringdata_DancerThread.data,
...
void *DancerThread::qt_metacast(const char *_clname)
{
    ...
    return DataReceivingThread::qt_metacast(_clname);
}

int DancerThread::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = DataReceivingThread::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
